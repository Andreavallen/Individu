			...
			<div class="container-fluid">
				...
				<form action="" id="manage-user">	
					...
					<div class="row">
                        ...
                        <div class="form-group col-md-4">
                            <label for="middlename" class="control-label"> Nama Tengah</label>
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <select type="text" id="gender" name="gender" class="form-control form-control-sm form-control-border select2" required>
                                <option <?= isset($gender) && $gender == "Male" ? 'selected' : '' ?>>PRia</option>
                                <option <?= isset($gender) && $gender == "Female" ? 'selected' : '' ?>>Wanita</option>
                            </select>
                        </div>
                        <div class="form-group col-md-4">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            <label for="cpassword" class="control-label">Konfirmasi Password</label>
                            <div class="input-group input-group-sm">
						...
						<small class="text-muted"><i>Kosongkan File Kata Sandi Baru jika Anda tidak ingin memperbaruinya.</i></small>
                    </div>
                    <div class="row">
                        <div class="form-group col-md-6">
					...
					<div class="row">
						<div class="form-group col-md-6">
							<label for="oldpassword" class="control-label">Masukkan Kata Sandi Saat Ini</label>
							<div class="input-group input-group-sm">
