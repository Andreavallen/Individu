                    ...
                    <form id="vregister-frm" action="" method="post">
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                <label for="shop_name" class="control-label">Nama Toko</label>
                                <input type="text" id="shop_name" autofocus name="shop_name" class="form-control form-control-sm form-control-border" required>
                            </div>
                            <div class="form-group col-md-6">
                                <label for="shop_owner" class="control-label">Nama Lengkap Pemilik Toko</label>
                            ...
                            <div class="form-group col-md-6">
                                <label for="shop_type_id" class="control-label">Tipe TOko</label>
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                <label for="logo" class="control-label">Logo toko</label>
                        ...
                        <div class="row align-item-end">
                            ...
                            <a href="<?= base_url.'vendor/login.php' ?>">Sudah memiliki akun</a>
                            </div>
                        <!-- /.col -->
                        </div>
                    </form>
